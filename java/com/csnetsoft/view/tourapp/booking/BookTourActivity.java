...
public class BookTourActivity extends Activity {
	...
	setContentView(R.layout.book_tour_view);
	mPref=(SharedPreferences)
			PreferenceManager.getDefaultSharedPreferences(BookTourActivity.this);
	...
	private void setEventListener() {
		...
		btn_action1.setOnClickListener(new OnClickListener() {
			...
			dbl.Close();
				...
				Intent mIntent=new Intent(BookTourActivity.this,BookTourActivity.class);
				startActivity(mIntent);
			    BookTourActivity.this.finish();
	...
	boolean flag=true;
			...
			setResult(RESULT_OK);
				...
				Intent mIntent=new Intent(BookTourActivity.this,ViewTourBookActivity.class);
				startActivity(mIntent);
			    BookTourActivity.this.finish();
	...
	private void InitAllViews() {
		...
		et_name=(EditText)findViewById(R.id.bt_et_name);
		et_email=(EditText)findViewById(R.id.bt_et_email);
		et_phone=(EditText)findViewById(R.id.bt_et_phone);
		et_city=(EditText)findViewById(R.id.bt_et_city);
		spin_gender=(Spinner)findViewById(R.id.bt_spin_gender);
		et_address=(EditText)findViewById(R.id.bt_et_address);
		et_age=(EditText)findViewById(R.id.bt_et_age);
		
		btn_action1=(Button)findViewById(R.id.bt_btn_action1);
		btn_action2=(Button)findViewById(R.id.bt_btn_action2);
